...
import { BasicTableComponent } from './views/pages/tables/basic-table/basic-table.component';
...
const routes: Routes = [
  { path:'auth', loadChildren: () => import('./views/pages/auth/auth.module').then(m => m.AuthModule) },
  {
    ...
    children: [
      ...
      {
        path: 'demo',
        loadChildren: () => import('./views/pages/demo-page/demo-page.module').then(m => m.DemoPageModule)
        },
